...
const TechStacks = () => {
  ...
  return (
    <div>
      <motion.div
        className="text-xl lg:text-2xl 2xl:text-4xl font-bold text-center lg:text-left"
        ref={ref}
        variants={variants}
        initial={false}
      ...
      {windowWidth > 1024 ? (
        ...
        <motion.div
          className="grid grid-cols-4 grid-rows-3 w-[300px] md:w-[350px] lg:w-[400px] 2xl:w-[450px] relative"
          ref={ref}
          variants={variants}
          initial={false}
          animate={isInView ? "animate" : "initial"}
              ...
              <AnimatePresence mode="wait">
                {selectedStack.icon && (
                  <motion.div
                    ...
                    variants={selectedStackVariants}
                    initial="initial"
                    animate="animate"
                    exit="exit"
                  >
