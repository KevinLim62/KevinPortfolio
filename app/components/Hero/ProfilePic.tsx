...
const ProfilePic = () => {
  ...
  return (
    ...
    >
      ...
      <div className='hidden lg:block absolute left-[20px] top-[20px] transition-transform delay-150 duration-200 group-hover:translate-x-[10px] group-hover:translate-y-[10px] lg:w-[350px] lg:h-[450px] 2xl:w-[425px] 2xl:h-[600px] border-2 rounded-lg bg-card'></div>
    </motion.div>
  );
};
