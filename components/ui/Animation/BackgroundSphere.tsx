...
const BackgroundSphere = () => {
  ...
  return (
    <motion.div ref={sceneRef} variants={variants} initial={false} animate={isInView ? 'animate' : 'initial'} className='absolute inset-0 z-0'>
      <Spline
        scene='https://prod.spline.design/a0nzUnFI2BHHkaxq/scene.splinecode'
        onLoad={(e) => {
          const obj = e.findObjectByName('background-spheres');
          sphereRef.current = obj;
        }}
      />
    </motion.div>
  );
